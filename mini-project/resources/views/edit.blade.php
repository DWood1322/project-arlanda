    ...
    <div class="container mt-4">
        <div class="row">
            <div class="card">
                ...
                @endif
                     <!-- START FORM -->
     <form action="/update/{{ $data->project_id }}" method="POST">
        @csrf
        <div class="my-3 p-3 bg-body rounded shadow-sm">
            <div class="mb-3 row">
                <label for="nim" class="col-sm-2 col-form-label">Project Name</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control" value="{{ $data->project_name }}"  name='project_name' id="project">
                </div>
            </div>
            <div class="form-group row mb-3 row">
                <label for="client" class="col-sm-2 col-form-label">Client</label>
                <div class="col-sm-10">
                    <select id="client"  value="{{ $data->client_id }}"  name="client_id" class="form-control">
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                    {{ date('d M Y', strtotime($data->project_start) ) }}
                </div>
            </div>
            <div class="mb-3 row">
                <label for="jurusan" class="col-sm-2 col-form-label">project end</label>
                <div class="col-sm-10">
                    {{ date('d M Y', strtotime($data->project_end) ) }}
                </div>
            </div>
            <div class="form-group row mb-3 row">
                ...
                <div class="col-sm-10">
                    <select id="status" name="project_status" class="form-control">
                        <option value="" >{{ $data->project_status }}</option>
